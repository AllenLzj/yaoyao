...
{
    //验证邮箱
    $emailMatch = "/^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,})$/";
    if (!preg_match($emailMatch, $email)) {
        return false;
    } else {
        return true;
    }
 ...
 * @return array
 */
function int_to_string2(&$data, $map = array('status' => array(1 => '正常', -1 => '删除', 0 => '禁用', 2 => '未审核', 3 => '草稿')))
{
