...
CREATE TABLE `yy_article`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of yy_article
-- ----------------------------
INSERT INTO `yy_article` VALUES (1, '文章1', 1, '内容内特容', '2019-04-25 13:40:14', '2019-05-05 17:03:55', 14, 11, NULL);
INSERT INTO `yy_article` VALUES (2, '文章1', 2, '内容内特容', '2019-04-25 13:40:14', '2019-04-29 14:00:47', 2, 3, NULL);
INSERT INTO `yy_article` VALUES (4, '', 187, '', '2019-05-05 10:38:39', NULL, 0, 0, NULL);
INSERT INTO `yy_article` VALUES (5, '', 187, '', '2019-05-05 10:39:07', NULL, 0, 0, NULL);
INSERT INTO `yy_article` VALUES (6, '', 187, '', '2019-05-05 10:39:12', '2019-05-05 17:13:22', -4, 0, NULL);
...
CREATE TABLE `yy_article_comment`  (
  ...
  `create_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章评论表' ROW_FORMAT = Compact;
...
CREATE TABLE `yy_article_like`  (
  ...
  `create_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章点赞表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of yy_article_like
-- ----------------------------
INSERT INTO `yy_article_like` VALUES (1, 1, 1, '2019-04-25 13:42:09');
...
INSERT INTO `yy_article_like` VALUES (11, 1, 1, '2019-04-29 11:33:58');
INSERT INTO `yy_article_like` VALUES (12, 1, 1, '2019-04-29 11:35:16');
INSERT INTO `yy_article_like` VALUES (13, 1, 1, '2019-04-29 11:35:18');
INSERT INTO `yy_article_like` VALUES (14, 1, 1, '2019-04-29 11:35:19');
INSERT INTO `yy_article_like` VALUES (15, 1, 1, '2019-04-29 11:35:41');
INSERT INTO `yy_article_like` VALUES (16, 1, 1, '2019-04-29 11:35:47');
INSERT INTO `yy_article_like` VALUES (17, 1, 1, '2019-04-29 11:38:52');
INSERT INTO `yy_article_like` VALUES (18, 1, 1, '2019-04-29 11:38:53');
INSERT INTO `yy_article_like` VALUES (19, 1, 1, '2019-04-29 11:38:55');
INSERT INTO `yy_article_like` VALUES (20, 1, 1, '2019-04-29 11:38:56');
INSERT INTO `yy_article_like` VALUES (21, 1, 1, '2019-04-29 11:38:59');
INSERT INTO `yy_article_like` VALUES (22, 1, 1, '2019-04-29 13:57:24');
...
CREATE TABLE `yy_email_code`  (
  ...
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '邮件验证码表' ROW_FORMAT = Compact;
...
CREATE TABLE `yy_invitation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '邀请帖子表' ROW_FORMAT = Compact;
...
INSERT INTO `yy_invitation` VALUES (7, 1, 1, 3, '23213', '3131231', '23132', '132132', 3, 0, '2019-04-29 11:01:15', '11111', 0, 4);
INSERT INTO `yy_invitation` VALUES (8, 1, 1, 3, '23213', '3131231', '23132', '132132', 3, 0, '2019-04-29 11:01:24', '11111', 1, 4);
...
-- Records of yy_user
-- ----------------------------
INSERT INTO `yy_user` VALUES (1, NULL, '1', '4e3988009121972e1b919354e26a1f10', '从11心。', 1, 71, 1, '2019-04-06 23:27:40', '2019-05-05 16:49:01', 0, '2019-05-05 16:00:31', '192.168.9.134');
INSERT INTO `yy_user` VALUES (2, '13758248144', '693021325@qq.com', '4e3988009121972e1b919354e26a1f10', '嘿嘿嘿', NULL, 1, 1, NULL, '2019-05-05 16:50:07', 1, '2019-05-05 16:50:06', '192.168.9.147');
...
CREATE TABLE `yy_user_invitation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '帖子参与表' ROW_FORMAT = Compact;
