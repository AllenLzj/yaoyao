...
-- Records of yy_admin
-- ----------------------------
INSERT INTO `yy_admin` VALUES (61, 'admin', '4e3988009121972e1b919354e26a1f10', '13758248144', '2019-05-25 10:43:08', 2130706433, 1, '2017-11-27 17:29:39', '2019-05-25 10:43:08');
...
INSERT INTO `yy_article` VALUES (15, '东哥嘿帅', 1, '平底地图给你做lz咯咯lzlzlz咯', '2019-05-10 11:23:36', '2019-05-25 10:34:11', 1, 0, NULL, 1);
...
CREATE TABLE `yy_article_like`  (
  ...
  `create_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章点赞表' ROW_FORMAT = Compact;
...
INSERT INTO `yy_article_like` VALUES (39, 1, 15, '2019-05-25 10:34:11');
...
) ENGINE = InnoDB AUTO_INCREMENT = 238 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单' ROW_FORMAT = Compact;
...
CREATE TABLE `yy_place`  (
  ...
  `monday` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '周一空余时间(1,2  为第一二节课可预约)',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '预约场地表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yy_place_time`  (
  ...
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 8436 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '预约场地空余时间表' ROW_FORMAT = Dynamic;
