...
CREATE TABLE `yy_invitation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='邀请帖子表';
...
CREATE TABLE `yy_menu` (
  ...
  KEY `pid` (`pid`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=204 DEFAULT CHARSET=utf8 COMMENT='菜单';
...
-- Records of yy_user
-- ----------------------------
INSERT INTO `yy_user` VALUES ('1', null, '693021325@qq.com', '4e3988009121972e1b919354e26a1f10', '从心。', '1', '1', '1', '2019-04-06 23:27:40', '2019-04-07 01:00:24');
INSERT INTO `yy_user` VALUES ('2', '13758248144', '6930213258@qq.com', '4e3988009121972e1b919354e26a1f10', '嘿嘿嘿', null, '1', '1', null, null);
